...
/// </summary>
[ExecuteInEditMode]
public abstract class UITweener : NGUIMonoBehaviour
{
    /// <summary>
    ...
    private static AnimationCurve defaultAnimationCurve = new AnimationCurve( new Keyframe( 0f, 0f, 0f, 1f ), new Keyframe( 1f, 1f, 1f, 0f ) );
    /// <summary>
    ...
    public AnimationOrTween.Direction direction
    {
        get
        {
            return amountPerDelta < 0f ? AnimationOrTween.Direction.Reverse : AnimationOrTween.Direction.Forward;
        }
    }
    ...
    {
        T comp = NGUIMonoBehaviour.GetComponent<T>( go );
#if UNITY_FLASH
        ...
        comp.animationCurve = defaultAnimationCurve;
    ...
    public float m_PreTime = 0f;
    public float m_StartTime = 0f;
    public float m_Duration = 0f;
    public float m_AmountPerDelta = 1000f;
    public int m_PingPongOneCount = 0;
    public float m_amountPerDelta = 0f;

    public void OnPlayOrPause( bool _isPlay )
    {
        isPlay = _isPlay;
    }
